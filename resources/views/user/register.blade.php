  ...
  <div class="container-fluid">
    <div class="row vh-100">
      <div class="left col-lg-6 col-md-6 col-sm-12 d-flex align-items-center">
        <form method="POST" action="register" class="form container col-md-12 col-lg-8">
            @csrf
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="password" name="Cpassword" class="form-control p-md-2" id="Cpassword" :value="old('Cpassword')"/>
          </div>
          <div class="mb-3">
